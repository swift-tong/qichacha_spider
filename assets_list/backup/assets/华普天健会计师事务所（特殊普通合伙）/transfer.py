...
class MakeTransfer():
    ...
    def set_excel_name(self):
        ...
        if os.path.exists('E:\workspace\接单\code_3'):
            ...
            self.final_name = r'E:\接单\code_3\final\股东变更.xlsx'
    ...
    def transfor_union(self,file4):
        ...
        with open(file4,'r',encoding='utf-8') as f:
            lines=[va.replace('\n','') for va in f.readlines()]
            for index,value in enumerate(lines):
                if '合伙人姓名或名称' in value:
    ...
    def write_excel(self):
        ...
        for key,value in name_dict.items():
            ...
            final_list[2] = value[0][0]
            if value[-1][0] != self.time_list[-1]:
                final_list[4] = value[-1][0]
